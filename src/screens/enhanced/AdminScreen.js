// screens/enhanced/AdminScreen.js - Fixed comprehensive admin dashboard
            ...
            <View style={styles.chartBar}>
              <View 
                style={[
                  ...
                  { width: `${dashboardData.users.totalUsers > 0 ? (item.count / dashboardData.users.totalUsers) * 100 : 0}%` }
                ]} 
              />
            </View>
